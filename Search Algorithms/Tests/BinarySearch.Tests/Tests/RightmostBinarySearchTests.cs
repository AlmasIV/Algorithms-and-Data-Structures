...
[TestClass]
public class RightmostBinarySearchTests
{
	[TestMethod]
	[ExpectedException(typeof(ArgumentNullException))]
	public void Search_PassNull_ThrowsArgumentNullException()
	{
		RightmostBinarySearch<int>.Search(null!, 1);
	}
	...
	public void Search_PassSingleElementArrayAndExistingTarget_WorksAsExpected()
	{
		...
		int actual = RightmostBinarySearch<int>.Search(sortedArray, target);
	...
	{
		int expected = Array.LastIndexOf(sortedArray, target);
